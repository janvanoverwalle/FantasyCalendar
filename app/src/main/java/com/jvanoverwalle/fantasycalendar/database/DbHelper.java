...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private ContentValues createContentValues(Calendar c) {
        ...
        contentValues.put(DbContract.CalendarTable.COL_NAME, c.getYearLength());
    ...
    private int insertCalender (SQLiteDatabase db, Calendar c) {
        Log.d(LOG_TAG, "Inserting new calendar record in database [" + DbContract.CalendarTable.TABLE + "]");
